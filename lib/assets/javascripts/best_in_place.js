...
BestInPlaceEditor.prototype = {
  ...
  activate : function() {
    ...
    this.oldValue = this.isNil() ? "" : this.original_content;
  ...
  abort : function() {
    this.activateText(this.current_value||"");
    jQuery(this.activator).bind('click', {editor: this}, this.clickHandler);
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.current_value     = self.current_value     || $parent.attr("data-current-value");
    });
    ...
    self.current_value     = self.element.attr("data-current-value")       || self.current_value;
  ...
  loadSuccessCallback : function(data) {
    ...
    if(data && data!=""){
      ...
      if (response !== null && response.hasOwnProperty("display_as")) {
        this.element.data("current-value", response["display_as"]);
        this.current_value = response["display_as"];
        original_value = response.hasOwnProperty("original_value") ? response["original_value"] : response["display_as"];
        // we need this to be available in the success hooks...
        this.element.attr("data-original-content", original_value);
        this.original_content = original_value;
        this.activateText(this.current_value);
      } else {
        original_value = this.element.text();
        this.element.data("current-value", original_value);
        this.element.data("original-content", original_value);
        this.current_value    = original_value;
        this.original_content = original_value;
      }
